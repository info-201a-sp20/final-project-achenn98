...
the state with the most number of clinics: 
the highest number of clinics available in a single state:
the rate of abortions per state: 
which state had the highest abortion rate:
the highest rate per region:   
