...
## Summary Table 
```{r, echo=FALSE}
kable(joined_df, col.names = c("State", "% Change in abortion rate",
                               "% Change in the no. of abortion clinics",
                               "Abortion Rate",
                               "Number of women using contraceptives",
                               "Change in the no. of abortion clinics",
                               "No. of abortion clinics", "State Code",
                               "Region", "Division"))
```
